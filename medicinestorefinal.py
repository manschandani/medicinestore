...
def createdb():
    global mycn
    global mycur
    mycn=sqlct.connect(host="localhost",user="root",password="8178334052",database="apollo_pharmacy")
    ...
    mycur.execute(cmd1)
    cust1="Create table if not exists customertable(BillNumber int,Customername varchar(50),Doctorname varchar(50),Productcode integer,\
    Quantity integer)"
    mycur.execute(cust1)
#---------MEDICINE(SHOP OWNER)-------------------------
